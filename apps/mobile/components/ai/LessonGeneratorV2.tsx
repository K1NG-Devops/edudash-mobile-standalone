...
export const LessonGeneratorV2: React.FC<LessonGeneratorProps> = ({
  userId,
  preschoolId,
  onLessonGenerated,
  onClose,
  ...
  const findEducationalVideos = (lesson: ResolvedLesson) => {
    ...
    Alert.alert(
      ...
      [
        { text: 'YouTube Search 1', onPress: () => console.log('Opening:', videoSuggestions[0]) },
        { text: 'YouTube Search 2', onPress: () => console.log('Opening:', videoSuggestions[1]) },
  ...
  const renderGenerationError = () => (
    <View style={styles.generatingContainer}>
      ...
      <View style={{ flexDirection: 'row', gap: 12, marginTop: 8 }}>
        <TouchableOpacity onPress={() => { setCurrentStep(1); setGenError(null); }} style={styles.previewButton}>
