...
DO $$ 
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema='public' AND table_name='activity_progress') THEN
...
IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'assignment_submissions_assignment_id_fkey') THEN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'homework_assignments') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='assignment_submissions') THEN
...
IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'assignment_submissions_student_id_fkey') THEN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'students') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='assignment_submissions') THEN
      ALTER TABLE "public"."assignment_submissions" 
...
IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'activity_progress_activity_id_fkey') THEN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'activities') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='activity_progress') THEN
...
IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'activity_progress_student_id_fkey') THEN
    IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'students') AND EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name='activity_progress') THEN
      ALTER TABLE "public"."activity_progress" 
