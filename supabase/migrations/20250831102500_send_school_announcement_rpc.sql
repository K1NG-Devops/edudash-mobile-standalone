...
-- SECURITY DEFINER RPC to send a school-wide announcement to selected audience
-- Sender must belong to a preschool; recipients are derived from that preschool.
